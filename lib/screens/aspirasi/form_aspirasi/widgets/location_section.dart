...
/// Displays an interactive map for choosing a location and a text field
/// for providing a human-readable location detail (e.g. "Kelas A lantai 2").
///
/// The user can:
/// 1. Tap "Use Current GPS" to auto-set the marker via device GPS.
/// 2. Tap anywhere on the map to reposition the marker manually.
/// 3. Pan / zoom the map freely.
/// 4. After GPS lock, further taps still move the marker (correction flow).
class LocationSection extends StatefulWidget {
  /// Currently selected coordinates (marker position).
  final LatLng? selectedLocation;

  /// Fires when the user taps the "Use Current GPS" button.
  final VoidCallback? onUseCurrentGps;

  /// Whether a GPS fetch is in progress.
  final bool isFetchingGps;

  /// Fires whenever the marker position changes — either via GPS or map tap.
  final ValueChanged<LatLng>? onLocationChanged;

  /// Controller for the "Detail Lokasi" text input below the map.
