...
class _UserFormDialog extends StatefulWidget {
  ...
  _UserFormDialog({required this.onSave, required this.departmentData, this.existing});
  @override
...
class _UserFormDialogState extends State<_UserFormDialog> {
  ...
  late final TextEditingController _departemenId, _nik, _noTelp;
  int? departmentId;
  ...
  void initState() {
    ...
    departmentId = widget.departmentData[widget.departmentData.keys.toList()[0]] ?? 1;
